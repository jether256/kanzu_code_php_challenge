...
if(isset($_POST['submit'])){
 ...
 $post= new Fom($con,$userLoggedIn);
  $post->postForm($_POST['org_nem'],$_POST['loc'],$_POST['f_nem'],$_POST['l_nem'],$_POST['age'],$_POST['children'],$_POST['married'],$_POST['tv'],$_POST['rad'],$_POST['car'],$_POST['fa_nem'],$_POST['ma_nem']);
}
?>
               ...
               <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="org_nem" class="form-control" placeholder ="name" >
                      </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="f_nem" class="form-control" placeholder ="first name">
                      </div>


                      <div class="col-md-6 mb-3">
                        <label><strong>Last Name</strong></label>
                        <input type="text" name="l_nem" class="form-control" placeholder ="last name">
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <br>
                        <input type="checkbox" name="rad" value="yes">
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="fa_nem" class="form-control" placeholder ="fathers name">
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="ma_nem" class="form-control" placeholder ="mothers name">
                      </div>
